    ...
    return (
        <section
            ...
            >
                ...
                <h2 className={`${playball.className} text-[32px] text-[#685952] mb-4 mt-5`}>Pemberkatan Pernikahan</h2>

                <div className="flex items-center justify-center text-[#685952] mb-6">
                ...
                <div className="text-[#685952] mb-6">
                ...
                <div>
                    <a
                        ...
                        target="_blank"
                        className="inline-flex items-center gap-2 bg-[#69564B] text-white px-4 py-1 rounded-full text-sm hover:bg-[#4a3d33] transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110"
                    >
            ...
            >
                ...
                <h2 className={`${playball.className} text-[32px] text-[#685952] mb-4 mt-5`}>Resepsi</h2>
